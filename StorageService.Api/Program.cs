...
using StorageService.Infrastructure.Messaging;
...
builder.Services.AddScoped<IUploadEventProducer, KafkaUploadProducer>();
builder.Services.AddHostedService<FileUploadConsumer>();
// Configure Kestrel
...
builder.Services.AddSingleton<IProducer<string, FileUploadRequestedEvent>>(sp =>
{
    var config = sp.GetRequiredService<IConfiguration>();
    return KafkaProducerFactory.Create<FileUploadRequestedEvent>(config);
});
